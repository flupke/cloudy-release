...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.last_deployment_status'
        db.alter_column(u'projects_node', 'last_deployment_status', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'Node.last_deployment_status'
        db.alter_column(u'projects_node', 'last_deployment_status', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'5b40114ea3924dd7b73931def3a679da'", 'max_length': '32', 'db_index': 'True'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'7db9fe1a6792415c9151af9250953076'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
