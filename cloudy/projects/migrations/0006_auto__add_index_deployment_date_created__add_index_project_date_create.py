...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Deployment', fields ['date_created']
        db.create_index(u'projects_deployment', ['date_created'])

        # Adding index on 'Project', fields ['date_created']
        db.create_index(u'projects_project', ['date_created'])

        # Adding index on 'DeploymentLogEntry', fields ['date']
        db.create_index(u'projects_deploymentlogentry', ['date'])


    def backwards(self, orm):
        # Removing index on 'DeploymentLogEntry', fields ['date']
        db.delete_index(u'projects_deploymentlogentry', ['date'])

        # Removing index on 'Project', fields ['date_created']
        db.delete_index(u'projects_project', ['date_created'])

        # Removing index on 'Deployment', fields ['date_created']
        db.delete_index(u'projects_deployment', ['date_created'])
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'bd7772314084471781c10701a394c123'", 'max_length': '32', 'db_index': 'True'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ebc7575f14fc4b0a9fd487d476558f28'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
