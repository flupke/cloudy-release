...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Deployment', fields ['project', 'name']
        db.create_unique(u'projects_deployment', ['project_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Deployment', fields ['project', 'name']
        db.delete_unique(u'projects_deployment', ['project_id', 'name'])
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'97159f9739d5454d9e781b7f1b41a205'", 'max_length': '32', 'db_index': 'True'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ca071c279bb94a5dbcfeeba386c8d751'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
