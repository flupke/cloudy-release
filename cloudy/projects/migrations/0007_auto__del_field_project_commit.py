...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.commit'
        db.delete_column(u'projects_project', 'commit')


    def backwards(self, orm):
        # Adding field 'Project.commit'
        db.add_column(u'projects_project', 'commit',
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'54646bf9b4784cdd9acf392f17b72dc7'", 'max_length': '32', 'db_index': 'True'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'d6ece3c885fa416b8848cd8eb233cf09'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
