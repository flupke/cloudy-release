...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.deploy_script_type'
        db.delete_column(u'projects_project', 'deploy_script_type')

        # Deleting field 'Project.deploy_script'
        db.delete_column(u'projects_project', 'deploy_script')

        # Adding field 'Project.deployment_script_type'
        db.add_column(u'projects_project', 'deployment_script_type',
                      self.gf('django.db.models.fields.CharField')(default='bash', max_length=32),
                      keep_default=False)

        # Adding field 'Project.deployment_script'
        db.add_column(u'projects_project', 'deployment_script',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.deploy_script_type'
        db.add_column(u'projects_project', 'deploy_script_type',
                      self.gf('django.db.models.fields.CharField')(default='bash', max_length=32),
                      keep_default=False)

        # Adding field 'Project.deploy_script'
        db.add_column(u'projects_project', 'deploy_script',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Project.deployment_script_type'
        db.delete_column(u'projects_project', 'deployment_script_type')

        # Deleting field 'Project.deployment_script'
        db.delete_column(u'projects_project', 'deployment_script')
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'18f1ce518b844b6c805d2730b952d6e1'", 'max_length': '32', 'db_index': 'True'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'efbf5fd1519a430796b9708c4d4c8ba8'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
