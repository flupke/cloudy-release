...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.base_dir'
        db.alter_column(u'projects_deployment', 'base_dir', self.gf('django.db.models.fields.CharField')(max_length=2047))

        # Changing field 'Project.repository_url'
        db.alter_column(u'projects_project', 'repository_url', self.gf('django.db.models.fields.CharField')(max_length=2047))

    def backwards(self, orm):

        # Changing field 'Deployment.base_dir'
        db.alter_column(u'projects_deployment', 'base_dir', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Project.repository_url'
        db.alter_column(u'projects_project', 'repository_url', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'7f402e2efa264a429b89e514c9be923f'", 'max_length': '32', 'db_index': 'True'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'90ef0e2a0e5249a489d0e5495a5538df'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
