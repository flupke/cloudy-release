...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.redeploy_bit'
        db.add_column(u'projects_deployment', 'redeploy_bit',
                      self.gf('django.db.models.fields.CharField')(default='e2ff64498a0b4efaba09bc8b4fb6487a', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.redeploy_bit'
        db.delete_column(u'projects_deployment', 'redeploy_bit')
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'5eb72e7eec914a518be305b671b6f110'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deployments'", 'to': u"orm['projects.Project']"}),
            'redeploy_bit': ('django.db.models.fields.CharField', [], {'default': "'964c5b1534254dfd9573e3ec9877f468'", 'max_length': '32'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'27bfa43030d44fd7b38490405a8bcf7c'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
