...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeploymentBaseVariables.deleted'
        db.add_column(u'projects_deploymentbasevariables', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeploymentBaseVariables.deleted'
        db.delete_column(u'projects_deploymentbasevariables', 'deleted')
    ...
    models = {
        ...
        u'projects.deployment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'438085434a7d44288af78153c6e0444a'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deployments'", 'to': u"orm['projects.Project']"}),
            'redeploy_bit': ('django.db.models.fields.CharField', [], {'default': "'88e881c6db024b42a6b894de705e78a3'", 'max_length': '32'}),
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'5eeaf20530434a80b802018e0ba2f092'", 'max_length': '32', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
